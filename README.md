...
This Repo is for learning purpose, it's a calculator with all basic functionalites, it is created with react's basic components.
...
### About The App
* User can use it according to their need, they can use create their own calculator with cloning this repo.
